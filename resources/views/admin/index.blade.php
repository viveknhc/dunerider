                            ...
                            <ul class="list-inline float-right mb-0 mr-3">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                        aria-expanded="false">
                                        <img src="{{asset('admin/images/users/avatar-1.jpg')}}" alt="user" class="rounded-circle img-thumbnail">
                                    </a>
                                ...
                                <div class="col-md-12 col-xl-3">
                                    <div class="card m-b-30 border-0">
                                        ...
                                        <div class="card-body  text-center">
                                            <img src="assets/images/users/avatar-5.jpg" alt="" class="rounded-circle mx-auto d-block w-25">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img class="" src="assets/images/products/pro1.png" alt="user" width="40"> </td>
                                                            <td>
                                                                Chair
                                                            </td>
                                                            <td>
                                                                <img src="assets/images/flags/us_flag.jpg" alt="" width="30">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="" src="assets/images/products/pro2.png" alt="user" width="40"> </td>
                                                            <td>
                                                                Mobile
                                                            </td>
                                                            <td>
                                                                <img src="assets/images/flags/french_flag.jpg" alt="" width="30">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="" src="assets/images/products/pro3.png" alt="user" width="40"> </td>
                                                            <td>
                                                                LED
                                                            </td>
                                                            <td>
                                                                <img src="assets/images/flags/spain_flag.jpg" alt="" width="30">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="" src="assets/images/products/pro4.png" alt="user" width="40"> </td>
                                                            <td>
                                                                Chair
                                                            </td>
                                                            <td>
                                                                <img src="assets/images/flags/russia_flag.jpg" alt="" width="30">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="assets/images/flags/italy_flag.jpg" alt="" width="30">
                                                            </td>
