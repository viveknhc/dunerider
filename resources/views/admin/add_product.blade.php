        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <button type="button" class="btn btn-raised btn-primary float-right" id="submitBtn">Save<div
                        ...
                        <!-- Tab panes -->
                        <form id="save_product" action="{{ url('admin/save_product') }}"
                                ...
                                <div class="tab-pane active pt-3" id="tabproduct" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-xl-6 col-6">
                                            ...
                                            <input type="text" class="form-control w-100" name="product_name"
                                                id="product_name">
                                        </div>
                                        <div class="form-group col-xl-6 col-6">
                                            <label for="product_slug" class="bmd-label-floating">Slug</label>
                                            <input type="text" class="form-control w-100" name="product_slug"
                                                id="product_slug">
                                        </div>
                                        <div class="form-group col-xl-6 col-6">
                                            <label for="product_priority" class="bmd-label-floating">Priority</label>
                                            <input type="text" class="form-control w-100" name="priority"
                                                id="product_priority">
                                        </div>
                                ...
                                <div class="tab-pane pt-3" id="tabdescription" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-xl-12 col-12">
                                            <label for="product_overview" class="bmd-label-floating">Product
                                                Overview</label>
                                            <br>
                                        ...
                                        <div class="form-group col-xl-12 col-12">
                                            <label for="product_inclusion" class="bmd-label-floating">Inclusion &
                                                Exclusion</label>
                                            <br>
                                        ...
                                        <div class="form-group col-xl-12 col-12">
                                            <label for="product_faq" class="bmd-label-floating">Faq & Additional
                                                Information</label>
                                            <br>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="card m-b-30">
                                                <div class="card-body">
                                                    ...
                                                    <input type="file" id="product_image1mob" name="product_image1mob"
                                                        class="dropify" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="card m-b-30">
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-muted font-14">200px * 200px</p>
                                                    <input type="file" id="product_image2mob" name="product_image2mob"
                                                        class="dropify" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="card m-b-30">
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-muted font-14">200px * 200px</p>
                                                    <input type="file" id="product_image4" name="product_image4"
                                                        class="dropify" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row col-md-12">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control w-100" name="product_tax_id"
                                                    id="product_tax_id">
                                            ...
                                            <div class="checkbox mb-2">
                                                <label>
                                                    <input type="checkbox" name="fixed_price" id="fixed_price"> Fixed Price
                                                </label>
                                            </div>
                                            
                                            <div class="checkbox mb-2">
                                                <label>
                                                    <input type="checkbox" name="private_item" id="private_item"> Private Item
                                                </label>
                                            </div>
                                            <div class="checkbox mb-2">
                                                <label>
                                                    <input type="checkbox" name="sharing_item" id="sharing_item"> Sharing Item
                                                </label>
                                            </div>
                                            <div class="checkbox mb-2">
                                                <label>
                                                    <input type="checkbox" name="child_price" id="child_price"> Child Price
                                                </label>
                                            </div>
                                            <div class="checkbox mb-2">
                                                <label>
                                                    <input type="checkbox" name="hourly_price_cb" id="hourly_price_cb"> Hourly Price
                                                </label>
                                            </div>
                                            <div class="checkbox mb-2">
                                                <label>
                                                    <input type="checkbox" name="list_on_addon" id="list_on_addon"> List
                                                    on Addons
                                                </label>
                                            </div>
                                            <div class="checkbox mb-2">
                                        ...
                                        <div class="col-md-6" id="hourly_price_div">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control w-100"
                                                    name="regular_price_hour" id="regular_price_hour">
                                            </div>
                                            <div class="form-group">
                                                <label for="offer_price_hour" class="bmd-label-floating">Offer Price
                                                    Per
                                                    1 Hour</label>
                                                <input type="number" class="form-control w-100" id="offer_price_hour"
                                        ...
                                        <div class="col-md-6" id="item_price_div">
                                            ...
                                            <div class="form-group">
                                                <label for="regular_price_sharing_adult"
                                                    ...
                                                    (Adult)</label>
                                                <input type="number" class="form-control w-100"
                                                    name="regular_price_sharing_adult" id="regular_price_sharing_adult">
                                            </div>
                                            <div class="form-group">
                                                <label for="offer_price_sharing_adult" class="bmd-label-floating">Offer
                                                    ...
                                                    Sharing (Adult)</label>
                                                <input type="number" class="form-control w-100"
                                                    id="offer_price_sharing_adult" name="offer_price_sharing_adult">
                                            </div>
                                            <div class="form-group" id="regular_price_sharing_child_div">
                                                <label for="regular_price_sharing_child"
                                                    ...
                                                    Sharing (Child)</label>
                                                <input type="number" class="form-control w-100"
                                                    id="regular_price_sharing_child" name="regular_price_sharing_child">
                                            </div>
                                            ...
                                            <div class="form-group" id="offer_price_sharing_child_div">
                                                <label for="offer_price_sharing_child" class="bmd-label-floating">Offer
                                                    ...
                                                    Sharing (Child)</label>
                                                <input type="number" class="form-control w-100"
                                                    id="offer_price_sharing_child" name="offer_price_sharing_child">
                                            </div>
                                           </div>
                                           <div class="col-md-6" id="item_price_div_private">
                                            <div class="form-group">
                                                <label for="regular_price_private_adult"
                                                    ...
                                                    (Adult)</label>
                                                <input type="number" class="form-control w-100"
                                                    name="regular_price_private_adult" id="regular_price_private_adult">
                                            </div>
                                            <div class="form-group">
                                                <label for="offer_price_private_adult" class="bmd-label-floating">Offer
                                                    ...
                                                    Private (Adult)</label>
                                                <input type="number" class="form-control w-100"
                                                    id="offer_price_private_adult" name="offer_price_private_adult">
                                            </div>
                                            <div class="form-group" id="regular_price_private_child_div">
                                                <label for="regular_price_private_child"
                                                    ...
                                                    Private (Child)</label>
                                                <input type="number" class="form-control w-100"
                                                    id="regular_price_private_child" name="regular_price_private_child">
                                            </div>
                                            ...
                                            <div class="form-group" id="offer_price_private_child_div">
                                                <label for="offer_price_private_child" class="bmd-label-floating">Offer
                                                    ...
                                                    Private (Child)</label>
                                                <input type="number" class="form-control w-100"
                                                    id="offer_price_private_child" name="offer_price_private_child">
                                            </div>
                                        ...
                                        <div class="col-md-6" id="fixed_price_div">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control w-100"
                                                    name="fixed_regular_price" id="fixed_regular_price">
                                            </div>
                                            <div class="form-group">
                                                <label for="fixed_offer_price" class="bmd-label-floating">Offer
                                                    Price</label>
                                                <input type="number" class="form-control w-100"
                                                    id="fixed_offer_price" name="fixed_offer_price">
                                            </div>
                                ...
                                <div class="tab-pane pt-3" id="tabmeta" role="tabpanel">
                                    <div class="row">
                                        <div class="form-group col-xl-6 col-6">
                                            ...
                                            <input type="text" class="form-control w-100" id="meta_title"
                                                name="meta_title">
                                        </div>
                                        <div class="form-group col-xl-6 col-6">
                                            <label for="meta_keywords" class="bmd-label-floating">Meta
                                                Keywords</label>
                                            <input type="text" class="form-control w-100" id="meta_keywords"
                                                name="meta_keywords">
                                        </div>
                                        ...
                                        <div class="form-group col-12">
                                            <label for="meta_description" class="bmd-label-floating">Meta
                                                Description</label>
                                            <textarea class="form-control w-100" id="meta_description"
